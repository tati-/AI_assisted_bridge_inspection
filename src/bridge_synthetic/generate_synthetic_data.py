...
# sample usage: python generate_synthetic_data.py -input ../../data/PIPO/3d_models/blender/bridge*.blend -savefolder ../../data/PIPO/dataset -textures ../../data/textures/bridge_materials/bridge_materials.blend
                python generate_synthetic_data.py  @dataset_config.txt -input ../../data/PIPO/3d_models/blender/bridge{33..35}.blend
"""
import os
import sys
import pdb
...
from modules.decorators import forall, timer
...
def get_args():
    ...
    arg('-textures', help='path to blender file with textures', type=str)
